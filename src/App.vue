  ...
  <div class="relative min-h-screen text-slate-100">
    ...
    >
      <nav class="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <button
          type="button"
          class="md:hidden inline-flex items-center justify-center rounded-full border border-slate-700 px-3 py-2 text-xs font-medium text-slate-200 hover:border-emerald-400 hover:text-emerald-300 transition"
        ...
        <nav class="max-w-5xl mx-auto px-4 py-3">
          <ul class="flex flex-col gap-2 text-sm text-slate-300">
            <li v-for="link in links" :key="link.href">
              <a
                :href="link.href"
                class="block rounded-lg px-3 py-2 hover:bg-slate-800/80 hover:text-emerald-300 transition"
      ...
      >
        ...
        <span class="flex items-center gap-4 justify-center sm:justify-end">
          <a
            ...
            class="inline-flex items-center gap-2 hover:text-emerald-300 transition"
